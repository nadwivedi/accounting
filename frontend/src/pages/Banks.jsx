            ...
            >
              <div className="flex shrink-0 items-center justify-between border-b border-white/15 bg-gradient-to-r from-cyan-700 via-blue-700 to-indigo-700 px-3 py-2 text-white md:px-4 md:py-2.5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold md:text-2xl">{editingId ? 'Edit Bank' : 'Add New Bank'}</h2>
                    <p className="mt-1 text-xs text-cyan-100 md:text-sm">Manage bank name, opening balance, and notes in one place.</p>
                  </div>
                </div>
                <button
                  type="button"
                  ...
                  <div className="rounded-xl border-2 border-indigo-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-2.5 md:p-4">
                    ...
                    <div className="grid grid-cols-1 gap-3 md:gap-4">
                      <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
                        <label htmlFor="bank-name" className="shrink-0 text-xs font-semibold text-gray-700 md:w-36 md:text-sm">
                      ...
                      <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
                        <label htmlFor="bank-balance" className="shrink-0 text-xs font-semibold text-gray-700 md:w-36 md:text-sm">
                          Total Balance
                        </label>
                        <input
                          id="bank-balance"
                          ...
                          onChange={handleInputChange}
                          className="min-w-0 flex-1 rounded-lg border border-transparent bg-transparent px-3 py-2 text-sm font-bold text-gray-900 transition-all placeholder:font-normal placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-200"
                      ...
                      <div className="flex flex-col gap-2 md:flex-row md:items-start md:gap-3">
                        <label htmlFor="bank-notes" className="shrink-0 pt-0.5 text-xs font-semibold text-gray-700 md:w-36 md:text-sm">
                          Notes
                        </label>
                        <textarea
                          id="bank-notes"
