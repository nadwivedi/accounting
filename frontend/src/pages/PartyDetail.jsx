  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-100 px-3 pb-6 pt-4 md:px-6 md:pt-6">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 px-4 py-4 md:px-6">
          <div>
            <h2 className="text-base font-bold text-white md:text-lg">Party Ledger</h2>
