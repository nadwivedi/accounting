          ...
          <div className="relative z-10 border-b border-slate-200/60 bg-gradient-to-r from-white/60 to-transparent px-5 py-5">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-cyan-600 shadow-lg shadow-emerald-500/30 text-white">
                  <config.Icon />
                </div>
                <div>
                  <p className="text-[15px] font-bold tracking-[0.18em] text-slate-800">List of Expense</p>
                ...
                return (
                  <Link
                    ...
                    className={`group relative flex items-center gap-3 border-b border-slate-200/90 px-5 py-2.5 text-[12px] transition-colors duration-200 last:border-b-0 ${
                      isActive
                        ? 'bg-[linear-gradient(90deg,rgba(204,251,241,0.96),rgba(240,253,250,0.94))] text-slate-800'
                        : 'text-slate-700 hover:bg-teal-50/90'
                    }`}
                  >
                    {isActive && <div className="absolute inset-y-0 left-0 w-1 bg-teal-500" />}
